...
mol load psf ../common/villin_wb.psf pdb ../common/villin_wb.pdb

set fil [open state.dat w]
...
set sll [measure contacts 8.5 $sel1 $sel1]
...
#######################################################################################
mol load psf common/villin_wb.psf dcd box/villin_wb_eq.dcd
